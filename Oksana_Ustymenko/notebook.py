...
def main():
    global tkn
    tkn = Tk()
    tkn.geometry("500x500+430+50")
    tkn.title("Персональний помічник. Нотатник")
    tkn.config(background="grey")
    tit_nb = Label(tkn, text="Нотатки", bg="grey", font='Arial 20', foreground="white")
    ...
    footer_nb = Label(tkn, text="© Dream Team", bg="grey", font='Arial 10', foreground="white")
