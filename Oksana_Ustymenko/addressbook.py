...
def main():
    global tka
    tka = Tk()
    tka.geometry("500x500+430+50")
    tka.title("Персональний помічник. Адресна книга")
    tka.config(background="grey")
    tit_ab = Label(tka, text="Адресна книга", bg="grey", font='Arial 20', foreground="white")
    ...
    footer_ab = Label(tka, text="© Dream Team", bg="grey", font='Arial 10', foreground="white")
