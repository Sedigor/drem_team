...
def main():
    global tko
    tko = Tk()
    tko.geometry("500x500+430+50")
    tko.title("Персональний помічник. Додаткові можливості")
    tko.config(background="grey")
    tit_other = Label(tko, text="Додаткові можливості", bg="grey", font='Arial 20', foreground="white")
    ...
    footer_other = Label(tko, text="© Dream Team", bg="grey", font='Arial 10', foreground="white")
